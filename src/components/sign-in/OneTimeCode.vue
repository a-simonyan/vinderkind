<template>
    <div class="flex flex-col max-w-[524px] m-auto w-full pt-[31px] sm:pt-[66px] pb-[66px] px-5 sm:px-0 lg:pt-[167px]">
        ...
        <CustomForm @submit="onSubmit" class="w-full">
            <span class="text-lg/[21px] text-charcoal font-raleway pb-3">
                Enter your one time code that was sent to: <span class="text-pinkish-purple">{{contact}}</span>
            </span>
            <div class="flex justify-between mt-1.5 code-wrap"><input type="text" maxlength="1" pattern="\d*" class="border-bottom">
            ...
            <div class="text-center">
                <button @click="sendNewCode" class="text-vivid-purple text-lg font-semibold mt-2.5 hover:opacity-75">Send new code</button>
            </div>
        </CustomForm>
    </div>
</template>
